...
from abc import ABC
from typing import Dict, Generator, Iterator, Iterable, Optional, Tuple, Union
...
class StatsCollector(ABC):
    ...
    @staticmethod
    def _wrap_metrics(
        metrics: Iterable[Tuple[str, Union[int, float]]],
        ...
        Args:
            metrics: Iterable of (metric_name, metric_value) tuples.
